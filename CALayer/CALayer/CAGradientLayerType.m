...
- (void)addLabel{
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 240, 50)];
...
//    startPoint endPoint 确定条纹方向 不设置 默认水平默认值[.5,0]和[.5,1]
    ...
    gradientLayer.bounds = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 300);
    gradientLayer.backgroundColor = [UIColor grayColor].CGColor;
    gradientLayer.position = CGPointMake([UIScreen mainScreen].bounds.size.width/2.0, 340);
