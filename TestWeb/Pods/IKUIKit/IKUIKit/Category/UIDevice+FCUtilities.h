...
//  - Only reduce functionality/effects on specific CPUs you've tested and found
//  to be too slow.
//
...
//
// - Having a cellular radio doesn't mean that it's enabled, or that your app is
// allowed to use it.
// - Having a cellular radio doesn't mean that Wi-Fi is enabled.
// - Assume "Unknown" could have either, both, or none. (Enable all features,
// controls, etc.)
