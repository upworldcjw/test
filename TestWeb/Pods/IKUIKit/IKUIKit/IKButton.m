...
- (void)layoutSubviews
{
    ...
    CGFloat titlePadding = (CGRectGetWidth(self.bounds) - titleW) * 0.5;
    ...
    switch (self.imageAlignment)
    {
        ...
        {
            self.titleEdgeInsets = UIEdgeInsetsMake(imageH/2+ space/2, -(titleCenterX-btnCenterX)-titlePadding, -(imageH/2 + space/2), titleCenterX-btnCenterX-titlePadding);
            self.imageEdgeInsets = UIEdgeInsetsMake(-(titleH/2 + space/2), btnCenterX-imageCenterX-titlePadding, titleH/2+ space/2, -(btnCenterX-imageCenterX)-titlePadding);
        }
            break;
